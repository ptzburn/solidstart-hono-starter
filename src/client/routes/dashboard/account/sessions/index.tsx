...
export default function SessionsRoute() {
  ...
  return (
    <div class="flex flex-1 flex-col container py-4 md:py-8 pb-20 md:pb-8 gap-4">
      <div>
        <h2>Sessions</h2>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead class="text-text hidden sm:table-cell">
                    IP Address
                  </TableHead>
                  <TableHead class="text-text hidden md:table-cell">
                    Signed in
                  </TableHead>
