...
export function TwoFactorSection() {
  ...
  async function handleVerifyTotpSubmit(code: string) {
  ...
  function handleEnableDialogClose(open: boolean) {
          ...
          <ItemContent>
            ...
            <ItemDescription>
              <ErrorBoundary
                fallback={null}
              >
                <Suspense fallback={<Skeleton class="w-16 h-4" />}>
