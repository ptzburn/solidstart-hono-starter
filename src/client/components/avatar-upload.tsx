...
export function AvatarUpload(props: AvatarUploadProps) {
  ...
  return (
    ...
    >
      ...
      <div
        class={`pointer-events-none absolute bottom-1 right-1 flex items-center justify-center rounded-full bg-background/90 text-muted-foreground opacity-0 shadow-sm transition-all duration-200 ease-out scale-90 group-hover:opacity-100 group-hover:scale-110`}
      >
        <Pencil class="size-4" />
      </div>
    </Button>
