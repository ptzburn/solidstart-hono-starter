...
const SelectTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <SelectPrimitive.Trigger
      class={cn(
        "flex h-10 w-full items-center justify-between rounded-md border border-input bg-transparent px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ui-disabled:cursor-not-allowed ui-disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40",
        local.class,
      )}
      {...others}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        {...others}
      >
        <SelectPrimitive.Listbox class="m-0 p-1 max-h-[calc(300px-0.5rem)] overflow-y-auto overscroll-contain" />
      </SelectPrimitive.Content>
    </SelectPrimitive.Portal>
  );
};
