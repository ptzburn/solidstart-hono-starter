...
const SliderThumb = <T extends ValidComponent = "span">(
  ...
  return (
    <SliderPrimitive.Thumb
      class={cn(
        "top-1/2 -translate-y-1/2 block size-6 rounded-full border-2 border-primary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
        local.class,
      )}
      {...others}
    >
